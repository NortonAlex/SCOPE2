...
%% aPAR
apar_names = {'simulation_number', 'year', 'DoY','LAIsunlit', 'LAIshaded'...
...
%% veg
veg_names = {'simulation_number', 'year', 'DoY', 'Photosynthesis', 'Electron_transport', 'NPQ_energy', 'LST'};
veg_units = {'', '', '', 'umol m-2 s-1', 'umol m-2 s-1', 'W m-2', 'K'};
